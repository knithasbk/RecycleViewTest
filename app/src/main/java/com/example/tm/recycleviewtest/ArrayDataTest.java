...
import static com.example.tm.recycleviewtest.DataWeatherAPI.parseAPIDataToReadableData.getIconResourceForWeatherCondition;
...
public class ArrayDataTest {
    ...
    private ArrayList<WeatherListData> weatherListDataArrayList = new ArrayList<WeatherListData>()  ;


    public ArrayDataTest() {
    }

    public ArrayList<WeatherListData> buildDataTest()   {
        ...
        try {
            ...
            int cityIdI = jsonObject1.getInt(weatherData.CITY_ID);
        ...
        /*Get Weather data and store to Database*/
            JSONArray jsonArray = jsonObject2.getJSONArray(weatherData.JSON_WEATHER_LIST_PARAMETERS);
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                int mImageItemAPI = Integer.parseInt(jsonObject2.getString(weatherData.JSON_WEATHER_LIST_STATUS_ICON));
