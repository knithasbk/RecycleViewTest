...
public class WeatherData {
    ...
    final public static String BASIC_URL = "http://api.openweathermap.org/data/2.5/forecast/city?id=";
    ...
    final public static String JSON_WEATHER_LIST_STATUS_ICON = "icon";
    ...
    public static final class WeatherColumnID {
        ...
        public static final int COLUMN_ID_DATE_OF_MONTH = 1;
        public static final int COLUMN_ID_DATE_OF_WEEK = 2;
